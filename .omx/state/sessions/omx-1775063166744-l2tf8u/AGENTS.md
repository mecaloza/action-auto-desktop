...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775063166744-l2tf8u | 2026-04-01T17:06:06.764Z

**Codebase Map:**
  src/main/: AudioEngine, handlers, MqttManager
  src/preload/: preload
  src/renderer/: App, CountDownRutine, InfoClass, PeopleBooked, QRContainer, RuntineIndicator, VideoContainer, main, Home, Routine
  src/shared/: roomLoadMapping, roomLoadMapping
  (root): vite.config
